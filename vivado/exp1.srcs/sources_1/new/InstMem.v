...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////                     
            //mem[17]=32'b00000010000000000000_10110_1101111;              //jal x21, 8       
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////      
//        //HANA'S INST MEM      
//            mem[20]=32'b0000000_00010_00000_001_01100_0100011;           //sh x2, 12(x0)
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            //branch
            //mem[17]=32'b0_000000_00001_00010_000_0100_0_1100011;        //beq x1, x2, 4
            //mem[19]=32'b0_000000_00001_00010_001_0100_0_1100011;        //bne x1, x2, 4
            mem[17]=32'b0_000000_00010_00001_100_0100_0_1100011;        //blt x1, x2, 4
            ...
            ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            //mem[17]=32'b00000000000000000100_10010_0010111;   //auipc x18, 4
            //mem[17]=32'b00000000000000000100_10010_0110111;   //lui x18, 4
            ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////            
            //Ecall, csr, fence
            //mem[17]=32'b000000000001_00000_000_00000_1110011;       //Ebreak
            //mem[17]=32'b000000000000_00000_000_00000_1110011; //ecall
            //mem[17]=32'b000000000000_00000_000_00000_1110011; //csr
            //mem[17]=32'b000000000000_00000_001_00000_0001111; //fence
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 end
